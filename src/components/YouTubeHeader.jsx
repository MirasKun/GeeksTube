...
const YouTubeHeader = () => {
  return (
    <div className="w-full h-screen bg-black">
      <header className="flex items-center justify-between px-4 h-14 border-b border-gray-700">
        <div className="flex items-center gap-4">
          <button className="p-2 rounded-full hover:bg-gray-700">
            <img src="/BurgerMenu.svg" alt="Burger Menu" className="w-6 h-6" />
          </button>
          <div className="flex items-center gap-1">
            <img src="/YouTube_Logo.svg" alt="YouTube" className="w-8 h-8" />
